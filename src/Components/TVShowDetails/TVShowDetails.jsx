...
export default function TVShowDetails() {
    ...
    useEffect( () => {    
        ...
        let { data } = await axios.get(`https://api.themoviedb.org/3/tv/${id}?api_key=dedb89745106639a2d878fb0c3f3dc20&language=en-US`);
        setMovie(data);
        }
        getMovie();
            ...
            <div className="row">
                <div className="col-md-4">
                    <div className="movieImage">
                        <img src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt="" className='img-fluid border p-2' />
                    </div>
                </div>
